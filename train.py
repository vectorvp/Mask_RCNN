...
ROOT_DIR = os.path.abspath("/home/vlad/mask_tf/Mask_RCNN/")
...
class CustomDataset(utils.Dataset):
    ...
    def load_custom(self, dataset_dir, subset):
        ...
        self.add_class("object", 3, "defective")
        ...
        annotations = json.load(open(os.path.abspath("/home/vlad/mask_tf/data/MRI_531.json")))
        ...
        for a in annotations:
            ...
            name_dict = {"disc": 1,"spinal canal": 2, "defective": 3}
            # key = tuple(name_dict)
